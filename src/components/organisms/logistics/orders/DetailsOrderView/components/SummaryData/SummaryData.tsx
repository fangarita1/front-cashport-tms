        ...
        <Flex vertical className={styles.container} style={{width: '100%'}}>
            ...
            <Row>
                ...
                <Col span={12} style={{display: "flex", flexDirection:"column", gap:"0.5rem", alignItems:"flex-end"}}>
                    ...
                    {vehiclesSuggested && <p className={styles.bodyStrong}>{vehiclesSuggested?.map(v=> v.vehicle_type_desc).join(',')}</p>}
                </Col>
            </Row>
            ...
            <Row>
                ...
                <Col span={12} style={{display: "flex", flexDirection:"column", gap:"0.5rem", alignItems:"flex-end"}}>
                    { needLiftingDestination &&
                        <p className={styles.bodyStrong}>Requiere alquilar izaje</p>                      
                    }
