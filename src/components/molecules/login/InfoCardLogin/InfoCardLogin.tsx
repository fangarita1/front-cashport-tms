...
export const InfoCardLogin = () => {
  return (
    <div className={styles.companySection}>
      ...
      <h1 className={styles.main_title}>Transport Managment System</h1>

      <h2 className={styles.subTitle}>
        <strong>Optimize</strong> your supply chain and
        <strong> reduce costs</strong> by centralizing logistics data, enabling smarter decisions
        and<strong> prioritizing high-impact actions.</strong>
      </h2>
